...
public class GoogleAuthenticator {
	 ...
	 * @return
	 */
	public static boolean authTest(String code,String savedSecret) {
		logger.debug("code = " + code+" savedSecret = "+savedSecret);
		...
		boolean r = ga.check_code(savedSecret, Long.valueOf(code), t);
		logger.debug("Check code = " + r);
		return r;
	}
	public static void main(String[] args) {
		String secret = GoogleAuthenticator.generateSecretKey(); 
		String qrcode = GoogleAuthenticator.getQRBarcode("量化后台", secret);
		 System.out.println("qrcode:" + qrcode + ",key:" + secret);
		GoogleAuthenticator ga = new GoogleAuthenticator();
		long t = System.currentTimeMillis();
		ga.setWindowSize(5);
//	    boolean r = ga.check_code("7XHSEO5WOZNQP5NN", 052252, t);
	 ...
	 * @return
	 */
	public static Map<String,String> genSecretTest(String loginName){
		Map<String,String> map=new HashMap<String,String>();
		String secret = GoogleAuthenticator.generateSecretKey();
		String url = GoogleAuthenticator.getQRBarcode(loginName,secret);
		logger.debug("loginName:"+loginName);
		logger.debug("Please register " + url);
		logger.debug("Secret key is " + secret);
		map.put("registerurl", url);
