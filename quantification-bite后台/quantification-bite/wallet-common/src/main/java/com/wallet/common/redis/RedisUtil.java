...
import com.wallet.common.enums.JedisEnum;
...
public final class RedisUtil {
    ...
    @Resource
       private RedisTemplate<String, Object> redisTemplate;
        ...
        public boolean setBizOperation(String biz,Long time) {
            ...
            String bizRediskey=(String)this.get(biz);
     ...
     * @return
     */
    public boolean lockCustomTime(String key,String value, int timeout) {
     ...
     * @return
     */
    public  String getContractOrder(String key){
        try {
//            Object str = redisTemplate.opsForList().index(key, 1);
    ...
    public static void main(String[] args) {
        ...
        boolean success= redisUtil.lockCustomTime("nvft:lock:1","1",10*60);
        if(success){//上锁成功
