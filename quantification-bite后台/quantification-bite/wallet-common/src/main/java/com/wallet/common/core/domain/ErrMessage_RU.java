...
public class ErrMessage_RU {
	...
	static {
		...
		workingMessage.put(CODE_SUCCESS, "запрос выполнен успешно");
		workingMessage.put(CODE_FAIL, "Запрос не выполнен");
		...
		workingMessage.put(CODE_PARAMETER_IS_ERROR, "Исключение параметра запроса");

        workingMessage.put(CODE_WRONG_ADDRESS, "Неверный адрес кошелька");
