package com.wallet.strategy.service.impl.okex.service.v5.account.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.wallet.strategy.service.impl.okex.bean.account.v5.param.IncreaseDecreaseMargin;
import com.wallet.strategy.service.impl.okex.bean.account.v5.param.SetLeverage;
import com.wallet.strategy.service.impl.okex.bean.account.v5.param.SetPositionMode;
import com.wallet.strategy.service.impl.okex.bean.account.v5.param.SetTheDisplayTypeOfGreeks;
import com.wallet.strategy.service.impl.okex.client.APIClientV5;
...
public class AccountAPIServiceImpl implements AccountAPIService {
    ...
    private APIClientV5 client;
    private AccountAPI api;

    public AccountAPIServiceImpl(APIConfiguration config) {
        this.client = new APIClientV5(config);
