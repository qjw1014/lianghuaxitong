...
public class APIClientV5 {
     ...
     */
    public APIClientV5(final APIConfiguration config) {
        ...
        this.client = new APIHttpClientV5(config, this.credentials).client();
...
//                responseInfo.append("\n\t\t\t").append(HttpHeadersEnum.OK_AFTER.header()).append(": ").append(response.headers().get(HttpHeadersEnum.OK_AFTER.header()));
        ...
        APIClientV5.LOG.info(responseInfo.toString());
    }
