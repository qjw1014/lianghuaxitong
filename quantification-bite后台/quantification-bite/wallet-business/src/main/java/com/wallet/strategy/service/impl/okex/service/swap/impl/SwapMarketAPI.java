...
public interface SwapMarketAPI {
    ...
    Call<String> getDepthApi(@Path("instrument_id") String instrumentId, @Query("size") String size, @Query("depth") String depth);
    ...
    Call<String> getTradesApi(@Path("instrument_id") String instrumentId, @Query("before") String before, @Query("after") String after, @Query("limit") String limit);
