package com.wallet.strategy.service.impl.okex.service.swap.impl;
...
import com.wallet.strategy.service.impl.okex.service.swap.SwapMarketAPIService;
...
public class SwapMarketAPIServiceImpl implements SwapMarketAPIService {
     ...
     */
    @Override
    public String getDepthApi(String instrumentId, String size,String depth) {
        return client.executeSync(api.getDepthApi(instrumentId, size,depth));
    }
     ...
     */
    @Override
    public String getTradesApi(String instrumentId, String before, String after, String limit) {
        return client.executeSync(api.getTradesApi(instrumentId, before, after, limit));
    }
