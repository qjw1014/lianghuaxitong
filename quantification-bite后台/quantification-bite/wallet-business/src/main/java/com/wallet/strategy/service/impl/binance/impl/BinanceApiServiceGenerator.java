...
import com.wallet.strategy.service.impl.binance.exception.BinanceApiTimeOutException;
import com.wallet.strategy.service.impl.binance.security.AuthenticationInterceptor;
...
public class BinanceApiServiceGenerator {
    ...
    public static <S> S createService(Class<S> serviceClass, String apiKey, String secret) {
        ...
        if (StringUtils.isEmpty(apiKey) || StringUtils.isEmpty(secret)) {
        	...
        	//Logity.info("调用binance信息:apiKey"+apiKey+"===secret"+secret);
    ...
    public static <T> T executeSync(Call<T> call) {
        try {
            ...
            throw new BinanceApiTimeOutException(e);
