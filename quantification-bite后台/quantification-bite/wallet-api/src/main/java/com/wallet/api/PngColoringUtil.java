...
public class PngColoringUtil {
    ...
    /**
     * @Description 给PNG图片增长背景色 返回base64
     * @Author 小帅丶
     * @param sourceImage 原始图片 最好是PNG透明的
     * @param backgroudColor 背景色
    ...
    /**
     * @Description 给PNG图片增长背景色 返回BufferedImage
     * @Author 小帅丶
     * @param sourceImage 原始图片 最好是PNG透明的
     * @param backgroudColor 背景色
    ...
    public static void main(String[] args) throws Exception{
        String image = "C:\\Users\\83888\\Desktop\\doge.jpg";//原始图片路径
        String resultImage = "C:\\Users\\83888\\Desktop\\doge1.jpg";//更改背景色后的图片路径
        changePNGBackgroudColor(image,resultImage, Color.MAGENTA);//原图 目标图 背景色
    }
}
